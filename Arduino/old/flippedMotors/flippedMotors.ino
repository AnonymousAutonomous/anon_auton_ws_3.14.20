...
void generic_callback(const eyes::Generic& generic_msg) {
  ...
  analogWrite(speedPin2, generic_msg.right_speed);
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(3), EncoderEvent2, CHANGE);
  attachInterrupt(digitalPinToInterrupt(2), EncoderEvent1, CHANGE);
