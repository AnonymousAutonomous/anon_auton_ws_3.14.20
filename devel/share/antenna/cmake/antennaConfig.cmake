...
if("TRUE" STREQUAL "TRUE")
  set(antenna_SOURCE_PREFIX /home/anonymous3/anon_auton_ws/src/antenna)
  set(antenna_DEVEL_PREFIX /home/anonymous3/anon_auton_ws/devel)
  set(antenna_INSTALL_PREFIX "")
  set(antenna_PREFIX ${antenna_DEVEL_PREFIX})
else()
  set(antenna_SOURCE_PREFIX "")
  set(antenna_DEVEL_PREFIX "")
  set(antenna_INSTALL_PREFIX /home/anonymous3/anon_auton_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'antenna' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anonymous3/anon_auton_ws/src/antenna/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT antenna_NUM_DUMMY_TARGETS)
      set(antenna_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::antenna::wrapped-linker-option${antenna_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR antenna_NUM_DUMMY_TARGETS "${antenna_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::antenna::wrapped-linker-option${antenna_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND antenna_LIBRARIES "${interface_target_name}")
