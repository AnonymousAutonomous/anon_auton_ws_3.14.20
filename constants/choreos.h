...
static const std::vector<eyes::Generic> RREVERSE_C = {
	[] {
		...
		first.left_forward = false;
		first.right_forward = false;
		first.left_speed = 150;
		first.right_speed = 150;
		first.timed = true;
		first.duration = 1;
		return first;
	}(),
	[] {
		...
		second.right_forward = false;
		second.left_speed = 200;
		second.right_speed = 200;
		second.timed = true;
		second.duration = 5;
		return second;
	}(),
	[] {
		...
		third.right_forward = false;
		third.left_speed = 200;
		third.right_speed = 200;
		third.timed = true;
		third.duration = 5;
		return third;
	}(),
...
static const std::vector<eyes::Generic> LCP_C = {
	[] {
		...
		first.left_speed = 200;
		first.right_speed = 200;
		first.timed = true;
		first.duration = 5;
		return first;
	}(),
